...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        self.pretrained_embeddings = nn.Embedding(embeddings.shape[0], self.embed_size) #num_embeddings, embedding_dim
    ...
    def embedding_lookup(self, t):
        ...
        emb_t = self.pretrained_embeddings(t)
        x = emb_t.view( emb_t.size()[0], self.n_features * self.embed_size )
    ...
    def forward(self, t):
        ...
        e2h = self.embed_to_hidden(emb)
        hidden_units = F.relu(e2h)
        drop = self.dropout(hidden_units)
